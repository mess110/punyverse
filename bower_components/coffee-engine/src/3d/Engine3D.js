...
Engine3D = (function() {
  function Engine3D() {
    ...
    this.renderer.domElement.addEventListener("mouseup", this.onDocumentMouseEvent, false);
    this.renderer.domElement.addEventListener("mousedown", this.onDocumentMouseEvent, false);
    this.renderer.domElement.addEventListener("mousemove", this.onDocumentMouseEvent, false);
    this.renderer.domElement.addEventListener("keydown", this.onDocumentKeyboardEvent, false);
    this.renderer.domElement.addEventListener("keyup", this.onDocumentKeyboardEvent, false);
